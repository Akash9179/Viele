...
| 2026-06-15 | **Onboarding sensitivity + taxonomy refinements** (design): shape/skin-tone screens made optional + reassuring + body-neutral labels; **height = iOS wheel picker**; **hair/eye taxonomies expanded** (hair: +Dark brown/Light brown/Auburn/Platinum/Colored; eyes: +Dark brown/Amber). **Pending:** grow SRS Appendix 11.3 | Akash: shape/coloring selection is sensitive — make it kind + not offensive |
